export { sortHighlight, useSortHighlight } from "./site-enhancements/sort-highlight";
...
export { productArticleHighlight } from "./site-enhancements/product-article-highlight";
